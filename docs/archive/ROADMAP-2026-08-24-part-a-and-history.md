> **ARCHIVED 2026-08-27.** This is `docs/ROADMAP.md` as it stood on 2026-08-24,
> kept whole. Part A (pilot readiness, A0–A7) is closed and is the reason it is
> here: A1, A4 and A5 are fully resolved, A2's vocabulary merge and classifier
> shipped, A0's four demo guardrails are spent — the HR demo happened — and the
> A7 catalogue is a 21-instance defect taxonomy that `CLAUDE.md` §Economy 0
> explicitly stopped extending.
>
> **Everything still open was carried forward** into the live
> [docs/ROADMAP.md](../ROADMAP.md); nothing was dropped silently. Come here for
> the *reasoning* behind a closed item — the measurements, the mutation results,
> the anchors — not for what to work on.

---

# Roadmap — HR pilot readiness, then next-gen features

> ## 🔴 2026-08-24 — **SUPERSEDED BY [docs/RESET.md](RESET-2026-08-24.md) FOR PRIORITY.**
>
