...
| `[evidence] min_quote_chars` | **32** — must equal `MatchWeights.evidence_min_quote_chars` (ADR-022 hardening). Floor below which a "verified" evidence quote is too short to be meaningful evidence at all. |
